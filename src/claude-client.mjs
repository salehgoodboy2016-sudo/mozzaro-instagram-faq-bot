...
export class ClaudeClient {
  ...
  async answer({ userText, context = [], knowledge }) {
    ...
    const system = [
      ...
      'كل رد آلي للعميل بالعربية السعودية فقط، دون أسماء أصناف أو ترجمات إنجليزية بين قوسين. إذا طلب العميل الإنجليزية صراحةً، يمكن الرد بها. عند طلب المنيو الكامل اختر menu_all ليُرسل ملف منيو المطعم، وعند أي استفسار عام عن الكيترنق اختر catering_document_request ليُرسل ملف الكيترنق المنفصل. الشكاوى والاقتراحات تُحال فورًا لموظف.',
